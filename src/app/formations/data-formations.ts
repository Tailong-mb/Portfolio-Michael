export const dataFormation = [
  {
    title: 'Epitech MSc Pro Intelligence artificielle (Futur)',
    duree: '(2022 – 2025)',
  ...
  },
  {
    ...
    description:
      "Dans le cadre d'une formation accélérée l'objectif principale était d'acquérier les bases nécessaires en informatique. Cette année m'a permis de développer un véritable attrait pour l'informatique.",
    logo: '../../assets/Ressources/computer-solid.svg',
  },
  {
  ...
  },
  {
    ...
    description:
      "Conséquence d'une affinité pour la mathématique, j'ai intégré ce crusus préparatoire. Forcé de constater que je n'avais pas d'intéret aussi bien pour la formation que sur le métier final, j'ai quitté la formation avant son terme.",
  ...
  },
  {
    ...
    description:
      'J\'ai effectué une baccalauréat générale S SVT avec une spécialité mathématique. Une mention "assez bien" fut acquise. J\'ai pu développer pendant la période du lycée des méthodes de travail et une rigueur grâce à des professeurs éxigeants.',
    logo: '../../assets/Ressources/calculator-solid.svg',
  },
];
