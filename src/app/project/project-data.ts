export const projectData = [
  {
    ...
    description:
      "Projet personnel ayant pour but de m'initier à Angular (component, routing, etc...) et de pratiquer des langages web. C'est l'occasion de créer mon premier site web qui me permet de présenter mes différents projets personnels.",
  ...
  },
  {
    ...
    description:
      'Labygame est un projet réalisé dans un cadre scolaire avec deux camarades. Pour sortir du labyrinthe, le joueur devra trouver une clef cachée, sans quoi la sortie ne sera pas ouverte. Le projet comporte trois interfaces : un menu, un environnement pour se déplacer dans le jeu et une interface de combat.',
